...
features = 8
data_path = '../data/BAC.csv'
day = [0] #add history to the set of features
...
upper, middle, lower = talib.BBANDS(close, timeperiod=14,matype=talib.MA_Type.T3)
...
np.savetxt("../data/percent.csv", percent)
...
for days in day:
    ...
    for margin in margins:
        ...
        if(os.path.exists("../data/data_/master_data_nifty101_ta/data"+margin)):
            pass
        else:
            os.makedirs("../data/data_/master_data_nifty101_ta/data"+margin)
        np.savetxt("../data/data_/master_data_nifty101_ta/data"+margin+"/close_ta_nifty_v3_"+str(days+1)+"day_history",history_days,delimiter=',')
        np.savetxt("../data/data_/master_data_nifty101_ta/data"+margin+"/close_ta_nifty_v3",final,delimiter=',')
        n_days = (features * (days + 1))
        final_load = np.loadtxt("../data/data_/master_data_nifty101_ta/data"+margin+"/close_ta_nifty_v3_" + str(days + 1) + "day_history", delimiter=',')
        ...
        np.savetxt("../data/data_/master_data_nifty101_ta/data"+margin+"/close_ta_nifty_z_v3_" + str(days + 1) + "day_history", final_load1, delimiter=',')